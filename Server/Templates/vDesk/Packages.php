...
<header>
    ...
    <p>
        For further information about packages and bundling resources, consider reading the <a href="<?= Functions::URL("Documentation", "Page", "Tutorials", "Tutorial", "CustomReleases") ?>">Custom releases</a>-tutorial.
    </p>
    ...
    <ul class="Packages Core">
        ...
        <li><a href="#Updates">Updates (in development)</a></li>
...
<section>
    ...
    <article class="Package" id="Packages">
        ...
        <section class="Description">
            <ul class="Features">
                <li class="Feature">Installing bundled packages from setup</li>
                <li class="Feature">(Un-)Installing packages</li>
                <li class="Feature">Creation of custom packages</li>
                <li class="Feature">Creation of custom setups</li>
            </ul>
            <aside onclick="this.classList.toggle('Fullscreen')">
    ...
    <article class="Package" id="Updates">
        <header>
            <h3>Updates (currently in development)</h3>
            <p>The Updates package will provide an updater and patch server.</p>
            <h4>License</h4>
            <p><a target="_blank" href="https://directory.fsf.org/wiki/License:MS-PL">Ms-PL</a></p>
            <h4>Dependencies</h4>
            <ul class="Dependencies">
        ...
        <section class="Description">
            <ul class="Features">
                <li class="Feature">Installing patches</li>
                <li class="Feature">Configurable update server</li>
                <li class="Feature">Hosting of own update server</li>
                <li class="Feature">Possibility of hosting a test system where you can test the newest updates while serving them for productive environments</li>
            </ul>
            <aside title="Currently in development" style="font-size: 100px; text-align: center">🚧</aside>
        </section>
    </article>
    ...
    <article class="Package" id="vDesk">
        <header>
            ...
            <h4>Requirements</h4>
            <ul class="Requirements">
                <li><span title="Required" class="Required">⚠</span> PHP >= 7.4</li>
                ...
                <li><span title="Required" class="Required">⚠</span> ECMAScript 6 compatible browser</li>
